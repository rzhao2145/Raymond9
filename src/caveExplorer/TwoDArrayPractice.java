...
//		drawSlot(pic, 4, 6);
	 ...
	 * Avoid an AIOOBE, but any portion of the Box that fits on the cavas should be drawn
	 */
	 ...
	 * In other words, there is a vertical line to the left of (i,j) and
	 * a vertical line to the right of (i,j)
